...
impl From<Extern> for Stmt {
    fn from(node: Extern) -> Stmt {
        Stmt::Extern(node)
    }
}
...
impl AstNode for Stmt {
    ...
    fn cast(syntax: SyntaxNode) -> Option<Self> {
        let res = match syntax.kind() {
            ...
            EXTERN => Stmt::Extern(Extern { syntax }),
